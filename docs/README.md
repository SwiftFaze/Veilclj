...
Narrative documentation lives here; `CLAUDE.md` only links to it.
...
| [mod-format.md](mod-format.md) | Writing or changing a mod, a `mod.json`, a theme or font file, or a new content type |
