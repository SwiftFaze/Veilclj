...
# {"version":1,"tested_at":"2026-09-19T20:53:23.767574Z","feature_name":"Thin Quil shell","feature_path":"specs/features/thin-quil-shell.feature","background_hash":"74234e98afe7498fb5daf1f36ac2d78acc339464f950703b8c019892f982b90b","implementation_hash":"unknown","scenarios":[{"index":9,"name":"Arithmetic and comparison are findings wherever they appear","scenario_hash":"179e2d1088649524021be0d6a74c9f78045777bb7bcfb64c6ff5fa0712a62703","mutation_count":15,"result":{"Total":15,"Killed":15,"Survived":0,"Errors":0},"tested_at":"2026-09-19T20:52:17.544170400Z"},{"index":14,"name":"A shell file that is missing is a finding, so a rename can't switch the check off","scenario_hash":"1f46bef12cdeab577f7731361fe7d8ba26f7c89064b629d9c0b3eb990cd9fe14","mutation_count":4,"result":{"Total":4,"Killed":4,"Survived":0,"Errors":0},"tested_at":"2026-09-19T20:52:17.544170400Z"},{"index":6,"name":"A raw Escape is recognised so Processing's quit can be suppressed","scenario_hash":"18f13df2f0b680fb26d2a0940817aec874281acf785706de505ce4ba88cd254d","mutation_count":8,"result":{"Total":8,"Killed":8,"Survived":0,"Errors":0},"tested_at":"2026-09-19T15:35:25.110079300Z"}]}
# acceptance-mutation-manifest-end

Feature: Thin Quil shell
  Everything the game decides at startup, on a key and about what is drawn
  where is a pure function with specs. What is left in
  ...
  Covers: the mod-load outcome at startup (a clean load gives the registry; a
    ...
    quit, and the shell check: which guards, calculations and branching forms it accepts and
  ...
  Supersedes: nothing, except that the draw-command scenarios (the colour and
    pixel position carried by each line of text) are gone: veil.ui.view/frame
    no longer returns pixel-positioned lines, and the cell-grid draw commands
    are pinned in terminal-cell-grid.feature. It narrows one out-of-scope item in
...
#   - The draw-command scenarios (pixel position and colour per line of text)
#     were replaced by terminal-cell-grid.feature, which pins the same
#     arithmetic per cell. What they guarded stays guarded: the shell check
#     still fails the build if that arithmetic returns to draw!.
